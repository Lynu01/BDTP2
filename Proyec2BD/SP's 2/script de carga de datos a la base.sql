...
<errorCodigo Id="10" Codigo="50010" Descripcion="Valor de documento de identidad no numérico"/>
...
<empleado Puesto="Fontanero" ValorDocumentoIdentidad="25008030" Nombre="Matthew Rodriguez" FechaContratacion="2025-04-16"/>
...
BEGIN TRY
    -- Convierte la cadena a XML (si hay problema de well-formed, aquí revienta)
    SET @x = CAST(@xmlStr AS XML);
