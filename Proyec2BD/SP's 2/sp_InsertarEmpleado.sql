/****** Object:  StoredProcedure [dbo].[sp_InsertarEmpleado]    Script Date: 10/17/2025 10:10:03 AM ******/
SET ANSI_NULLS ON
GO
...
BEGIN
    ...
    BEGIN TRY
        ...
        BEGIN
            ...
            SET @outResultCode = 50004; -- C�digo: ValorDocumentoIdentidad ya existe
			COMMIT TRANSACTION;
            RETURN;
        END
        ...
        BEGIN
            ...
            SET @outResultCode = 50005; -- C�digo: Nombre ya existe
			COMMIT TRANSACTION;
            RETURN;
        END
