...
public interface EmpleadoRepository extends JpaRepository<Empleado, Long> {
    ...
    @Procedure(procedureName = "dbo.sp_InsertarEmpleado", outputParameterName = "outResultCode")
    ...
    @Procedure(procedureName = "dbo.sp_EliminarEmpleado", outputParameterName = "outResultCode")
    ...
    @Procedure(procedureName = "dbo.sp_ActualizarEmpleado", outputParameterName = "outResultCode")
    Integer sp_ActualizarEmpleado(
        @Param("inValorDocumentoIdentidad") String valorDocumentoIdentidadOriginal,
