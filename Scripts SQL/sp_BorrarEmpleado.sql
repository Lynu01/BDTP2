...
BEGIN
    ...
    BEGIN TRY
        ...
        BEGIN
            -- Registro en Bit�cora: empleado no encontrado
            ...
            VALUES (
                9, -- Eliminaci�n no exitosa
                'No se encontr� empleado para eliminar. Documento: ' + @inValorDocumentoIdentidad,
