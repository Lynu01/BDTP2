...
BEGIN
    ...
    BEGIN TRY
        ...
        -- Verificar si el filtro es solo números (documento) o letras (nombre)
        ...
        BEGIN
            -- Filtro solo números: buscar por documento de identidad
            SELECT 
                e.Id
                ,e.Nombre
                ,e.ValorDocumentoIdentidad
            ...
            -- Registrar consulta con filtro de cédula
            ...
            VALUES (
                12 -- Consulta con filtro de cédula
                ,'Filtro de cédula utilizado: ' + @inFiltro
